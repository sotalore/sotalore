...
class Views::Authentication::Confirmations::New < Views::Authentication::Base
  ...
  def view_template
    auth_columns do
      div(class: "basis-full md:basis-1_2 lg:basis-1_3") do
        auth_card("Send Confirmation Instructions") do
          render Views::Authentication::Confirmations::Form.new(user: @user)
