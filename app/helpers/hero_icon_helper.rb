...
# </svg>
  ...
  CHEVRON_RIGHT = <<~ICON.html_safe
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
    </svg>
  ICON

  def hero_icon_chevron_right
    CHEVRON_RIGHT
  end
  ...
  def hero_icon_magnifying_glass
    MAGNIFYING_GLASS
  end
