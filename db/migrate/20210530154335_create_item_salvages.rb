class CreateItemSalvages < ActiveRecord::Migration[6.1]
  def change
    ...
    add_column :items, :salvage_as_result_count, :integer, limit: 2, default: 0, null: false
    add_column :items, :salvage_as_source_count, :integer, limit: 2, default: 0, null: false
  end
end
